...
namespace CAT.Message.Spi.Codec
{
    public class PlainTextMessageCodec : IMessageCodec
    {
        ...
        #endregion IMessageCodec Members
                                               ...
                                               Stack<ITransaction> stack, IMessageTree tree)
        {
            ...
            LoggerManager.Error("Unknown identifier(" + identifier + ") of message: " + buf);
        ...
        #endregion Nested type: BufferHelper
        ...
        #endregion Nested type: DateHelper
    }
}
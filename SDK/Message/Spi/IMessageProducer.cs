...
namespace CAT.Message.Spi
{
    ...
    public interface IMessageProducer
    {
        ...
        void LogError(Exception cause, string messageTreeId);
        ...
        void LogEvent(String type, String name, String status, String nameValuePairs, string messageTreeId);
        ...
        ///<param name="status"> "0" means success, otherwise means error code </param>
        ///<param name="nameValuePairs"> name value pairs in the format of "a=1&b=2&..." </param>
        void LogHeartbeat(String type, String name, String status, String nameValuePairs, string messageTreeId);
        ...
        /// <param name="status">"0" means success, otherwise means error code</param>
        /// <param name="nameValuePairs">name value pairs in the format of "a=1&b=2&..."</param>
        void LogMetric(String name, String status, String nameValuePairs, string messageTreeId);
        ...
        ///<param name="type"> event type </param>
        ///<param name="name"> event name </param>
        IEvent NewEvent(String type, String name, string messageTreeId);
        ...
        ///<param name="type"> heartbeat type </param>
        ///<param name="name"> heartbeat name </param>
        IHeartbeat NewHeartbeat(String type, String name, string messageTreeId);
        ...
        ITransaction NewTransaction(String type, String name, string messageTreeId);
        ...
        ///<param name="name"> metric name </param>
        IMetric NewMetric(String type, String name, string messageTreeId);
    }
}